...
import { LogOut, Folder, LayoutDashboard, Users } from "lucide-react";
			...
			<DropdownMenuContent className="w-56" align="end" forceMount>
				...
				{isDeveloper && (
					<>
						<DropdownMenuSeparator />
						<DropdownMenuItem asChild>
							<Link href="/developer" className="cursor-pointer w-full">
								<LayoutDashboard className="mr-2 h-4 w-4" />
								<span>Developer Dashboard</span>
							</Link>
						</DropdownMenuItem>
						<DropdownMenuItem asChild>
							<Link href="/developer/users" className="cursor-pointer w-full">
